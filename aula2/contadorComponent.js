(() => {
    const BTN_REINICIA = "btnReiniciar";
    ...
    class ContadorComponent {
        ...
        inicializar() {
            ...
            {
                const elementoBotao = document.getElementById(BTN_REINICIA);
                const desabilitarBotao = this.prepararBotao(elementoBotao, this.inicializar);
                desabilitarBotao();
                
                const argumentos = { elementoContador, idIntervalo };
                const efetuarParadaFn = this.agendarParadaContador.apply({ desabilitarBotao }, [argumentos]);
                contador.efetuarParada = efetuarParadaFn;
            }
        }
    }
